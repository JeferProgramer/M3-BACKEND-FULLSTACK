...
describe('Mock Functions', () => {
  ...
  describe('usingCallback', () => {
    ...
    //beforeEach(() => {}) se ejecuta antes de cada elemento
    //beferoAll(() => {}) se ejecuta antes de todos los elementos
    //afterEach(() => {}) se ejecuta despues de cada elemento
    //afterAll(() => {}) se ejecuta despues de todos los elementos
